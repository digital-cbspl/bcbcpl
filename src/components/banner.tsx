...
export default function HeroBanner() {
  const slides = [
    ...
    {
      image: Banner3.src,
      title: "Multi Storied Quarter Complex (OPTCL), Bhubaneswar",
